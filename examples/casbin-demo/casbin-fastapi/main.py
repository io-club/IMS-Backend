...
async def read_all_items(
    req: Request, curr_user: User = Depends(get_current_user_authorization)
):
...
async def read_item(
    item_id: int,
    req: Request,
    curr_user: User = Depends(get_current_user_authorization),
):
...
async def create_item(
    item: Item, req: Request, curr_user: User = Depends(get_current_user_authorization)
):
