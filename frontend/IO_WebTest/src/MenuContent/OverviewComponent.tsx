...
export default function OverviewComponent() {
  ...
  const [userImage, setUserImage] = useState(null); // 用户上传的图像
  const defaultIcon = (
    <div
      style={{
        borderRadius: '50%',
    ...
    >
      <img src={user} alt="Default Icon" style={{ maxWidth: '100%', maxHeight: '100%' }} />
    </div>
  );
  ...
  if (selectedMenu === 'overview') {
    ...
    componentToDisplay=<ProfileComponent/>
  }
