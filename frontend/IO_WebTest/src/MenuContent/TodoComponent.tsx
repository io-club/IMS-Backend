...
import { Layout, Menu, Modal, Button, Input } from 'antd';
            ...
            <div className='show-main'>
              ...
              <div className='box'>
                <div className='todo-box-1'>
                  <div className='todo-box-1-add'>
                    <Button className='todo-box-1-btn'
                    ...
                    <Modal
                      ...
                      className="todo-modal custom-modal" // 添加自定义类名
                      open={visiable}
                      onOk={onOk}
                      onCancel={closeModal}
                    ...
                    >
                      <Input
                        ...
                        className={listName.trim() ? '' : 'empty-input'}
                      />
                      {!listName.trim() && (
                        <div className="empty-input-tip" style={{ color:'red' }}>
                          {t("listnametip")}
                        </div>
                      )}
                    </Modal>
                  </div>
                  <div className='todo-box-1-list'>
                    从后端获取并显示
                  </div>
                </div>

                <div className='todo-box-2'>
                  从后端获取数据并显示（注意与列表的key对应）
                </div>
              </div>
              {/* ------------------------- */}
            </div>
